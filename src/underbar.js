...
(function() {
  ...
  _.last = function(array, n) {
		var startIndex = array.length - n > 0 ? array.length - n : 0;
		return n === undefined ? array[array.length-1] : array.slice(startIndex,array.length);
  };
  ...
  _.shuffle = function(array) {
		...
		for (var i = array.length - 1; i > 0; i--){
			...
			shuffledArray.push( newArray.splice(index,1) );
		}
